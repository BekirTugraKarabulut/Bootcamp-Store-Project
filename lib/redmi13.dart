...
class Redmi13 extends StatefulWidget {
  const Redmi13({super.key});

  @override
  State<Redmi13> createState() => _Redmi13State();
}

class _Redmi13State extends State<Redmi13> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Xiaomi Redmi 13 256GB" , style: TextStyle(fontFamily: "BebesNeue" , color: Colors.white),),
        centerTitle: true,
        ...
        children: [
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Padding(
                  ...
                  child: Image.asset("resim/redmi13.png" , scale: 4,),
                )
              ],
            ),
          ),
          const Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.stretch,
              children: [
                ...
                Text("\t\tEkran Boyutu : 	6.79 inch", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                ...
                Text("\t\tRenk Grubu		 : Altın", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
          ...
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                Text("10.999 ₺" , style: TextStyle(fontWeight: FontWeight.bold ,fontSize: 25 , color: Colors.white),),
