...
class Pro15iphone extends StatefulWidget {
  const Pro15iphone({super.key});

  @override
  State<Pro15iphone> createState() => _Pro15iphoneState();
}

class _Pro15iphoneState extends State<Pro15iphone> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("İphone 15 Pro 256GB" , style: TextStyle(fontFamily: "BebesNeue" , color: Colors.white),),
        centerTitle: true,
        ...
        children: [
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Padding(
                  ...
                  child: Image.asset("resim/141034-1_large.png" , scale: 4,),
                )
              ],
            ),
          ),
          const Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.stretch,
              children: [
                ...
                Text("\t\tRenk Grubu		 : Gri", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
          ...
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                Text("75.499 ₺" , style: TextStyle(fontWeight: FontWeight.bold ,fontSize: 25 , color: Colors.white),),
