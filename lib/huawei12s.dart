...
class Huawei12s extends StatefulWidget {
  const Huawei12s({super.key});

  @override
  State<Huawei12s> createState() => _Huawei12sState();
}

class _Huawei12sState extends State<Huawei12s> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Huawei Nova 12S" , style: TextStyle(fontFamily: "BebesNeue" , color: Colors.white),),
        centerTitle: true,
        ...
        children: [
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Padding(
                  ...
                  child: Image.asset("resim/nova.png" , scale: 4,),
                )
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                Text("21.499 ₺" , style: TextStyle(fontWeight: FontWeight.bold ,fontSize: 25 , color: Colors.white),),
