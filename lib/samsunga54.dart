...
class Samsunga54 extends StatefulWidget {
  const Samsunga54({super.key});

  @override
  State<Samsunga54> createState() => _Samsunga54State();
}

class _Samsunga54State extends State<Samsunga54> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Samsung Galaxy A54" , style: TextStyle(fontFamily: "BebesNeue" , color: Colors.white),),
        centerTitle: true,
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Padding(
                  ...
                  child: Image.asset("resim/samsunga54.png" , scale: 4,),
                )
              ],
            ),
          ),
          const Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.stretch,
              children: [
                ...
                Text("\t\tEkran Boyutu Aralığı : 6.6+ inch" , style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                Text("\t\tMobil Ram Boyutu (GB) : 8 GB", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                Text("\t\tEkran Boyutu : 	6.6 inch", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                Text("\t\tDahili Hafıza : 128 GB", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                ...
                Text("\t\tGaranti		 : 12", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
              ],
            ),
          ),
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                Text("16.499 ₺" , style: TextStyle(fontWeight: FontWeight.bold ,fontSize: 25 , color: Colors.white),),
