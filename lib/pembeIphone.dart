...
class Pembeiphone extends StatefulWidget {
  const Pembeiphone({super.key});

  @override
  State<Pembeiphone> createState() => _PembeiphoneState();
}

class _PembeiphoneState extends State<Pembeiphone> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Iphone 15 128GB Pembe" , style: TextStyle(fontFamily: "BebesNeue" , color: Colors.white),),
      centerTitle: true,
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Padding(
                  ...
                  child: Image.asset("resim/141002-1_large.png" , scale: 4,),
                )
              ],
            ),
          ),
          const Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.stretch,
              children: [
                Padding(
                  ...
                  child: Text("Özellikler" , style: TextStyle(fontWeight: FontWeight.bold , fontSize: 20 , color: Colors.white) , textAlign: TextAlign.center,),
                ),
                ...
                Text("\t\tRenk Grubu		 : Pembe", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
           ...
           Padding(
             ...
             child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                Text("54.999 ₺" , style: TextStyle(fontWeight: FontWeight.bold ,fontSize: 25 , color: Colors.white),),
