...
class Redmi13c extends StatefulWidget {
  const Redmi13c({super.key});

  @override
  State<Redmi13c> createState() => _Redmi13cState();
}

class _Redmi13cState extends State<Redmi13c> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Xiaomi Redmi 13C" , style: TextStyle(fontFamily: "BebesNeue" , color: Colors.white),),
        centerTitle: true,
        ...
        children: [
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Padding(
                  ...
                  child: Image.asset("resim/redmi13c.png" , scale: 4,),
                )
              ],
            ),
          ),
          const Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.stretch,
              children: [
                ...
                Text("\t\tEkran Boyutu : 	6.74 inch", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                ...
                Text("\t\tRenk Grubu		 : Lacivert", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
          ...
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                Text("7.499 ₺" , style: TextStyle(fontWeight: FontWeight.bold ,fontSize: 25 , color: Colors.white),),
