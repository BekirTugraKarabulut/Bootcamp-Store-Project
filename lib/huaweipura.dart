...
class Huaweipura extends StatefulWidget {
  const Huaweipura({super.key});

  @override
  State<Huaweipura> createState() => _HuaweipuraState();
}

class _HuaweipuraState extends State<Huaweipura> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Huawei Pura 70 PRO" , style: TextStyle(fontFamily: "BebesNeue" , color: Colors.white),),
        centerTitle: true,
        ...
        children: [
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Padding(
                  ...
                  child: Image.asset("resim/pura.png" , scale: 4,),
                )
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                Text("40.999 ₺" , style: TextStyle(fontWeight: FontWeight.bold ,fontSize: 25 , color: Colors.white),),
